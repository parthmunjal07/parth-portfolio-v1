      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="mt-5">
          <p className="text-xl text-left">
            ...
            India.
            <br />
            So lets begin with my journey. I had many hobbies at the time when I was in 8th-grade. I remember that I studied a bit of HTML and CSS for the first time.
            From there sparked a curiosity in tech world.
            <br />
