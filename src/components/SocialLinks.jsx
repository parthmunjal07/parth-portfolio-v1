...
export default function SocialLinks() {
  return (
    <div className="fixed bottom-0 left-4 md:left-8 z-50 flex flex-col items-center gap-5">
      {/* LinkedIn */}
      <a
        href="https://www.linkedin.com/in/parthmunjal07/"
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-400 hover:text-blue-500 transition-all hover:-translate-y-1"
        aria-label="LinkedIn"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-400 hover:text-pink-500 transition-all hover:-translate-y-1"
      ...
      <a
        ...
        className="text-gray-400 hover:text-red-400 transition-all hover:-translate-y-1"
